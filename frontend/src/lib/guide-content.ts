...
export const GUIDE_CONTENT: Record<GuideLanguage, GuideContent> = {
  en: {
    ...
    nextItems: [
      ...
      "Run Evidence searches and grounds supporting papers for each claim slot.",
    ...
    mistakesItems: [
      ...
      "Expecting supported citations before Run Evidence has completed.",
  ...
  ko: {
    ...
    nextItems: [
      ...
      "Run Evidence는 문장과 근거 논문을 검색하고 연결합니다.",
    ...
    mistakesItems: [
      ...
      "Run Evidence 전에 citation이 자동 검토되길 기대하는 것.",
